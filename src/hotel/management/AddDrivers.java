...
public class AddDrivers extends JFrame implements ActionListener{
	...
	contentPane.setLayout(null);
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("icons/Copy of eleven.jpg"));
	...
	l8.setBounds(64, 45, 102, 22);
	contentPane.add(l8);
        
        t6 = new JTextField();
	t6.setBounds(174, 45, 156, 20);
	contentPane.add(t6);
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                ...
                String str = "INSERT INTO driver values( '"+name+"', '"+age+"', '"+gender+"','"+company+"', '"+brand+"', '"+available+"','"+location+"','"+Id+"')";
