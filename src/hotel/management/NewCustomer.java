...
public class NewCustomer extends JFrame {
	...
	private JTextField t1,t2,t3,t4,t5,t6,t7;
        JComboBox comboBox;
        JRadioButton r1,r2,r22;
        Choice c1;
	
        public NewCustomer() throws SQLException {
		
                setBounds(190, 70, 850, 550);
		contentPane = new JPanel();
		setContentPane(contentPane);
		contentPane.setLayout(null);
                
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("icons/Copy of fifth.png"));
		...
		lblName.setBounds(125, 20, 260, 53);
		...
		contentPane.add(comboBox);
                ...
                JLabel l2 = new JLabel("IdProfNumber :");
		...
		lblDate.setBounds(35, 402, 200, 14);
